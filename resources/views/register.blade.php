                        ...
                        <div class="row">
                          ...
                          <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <div class="form-line form-line-submit buttons">
                              <button class="btn btn-yellow go-now" type="submit" value="Submit">GO NOW</button>
                              <a href="javascript:void(0)" class="btn btn-yellow">REQUEST</a>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="group-of-steps">
                      <div class="group-of-steps-content">
                        ...
                        <div class="id-step" data-step="2">
                          ...
                          <div class="id-step-element dropdown-step">
                            <div class="id-step-element-content">
                              ...
                              <div class="options-dropdown-content">
                                <div class="options-dropdow-element">
                                  <label data-sound-hover="sonidoC" data-sound-click="sonidoB">
                                    <input type="checkbox" name="id_step_option" value="Option 1">
                                ...
                                <div class="options-dropdow-element">
                                  <label data-sound-hover="sonidoC" data-sound-click="sonidoB">
                                    <input type="checkbox" name="id_step_option" value="Option 4">
